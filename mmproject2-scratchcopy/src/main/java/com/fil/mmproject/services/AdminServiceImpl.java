...
public class AdminServiceImpl implements AdminService {
	...
	public Admin updateAdmin(long id, Admin updatedAdmin) {
		...
		if (existingAdmin != null) {
			...
			existingAdmin.setReservation(updatedAdmin.getReservation());
	...
	public Reservation updateReservationByTransactionId(long transactionId, Reservation updatedReservation) {
		...
		if (existingReservation != null) {
			...
			// If the reservation with the given transaction ID is not found, you can choose
